...
const QString SmsSender::ACCOUNT_SID = "YOUR_TWILIO_ACCOUNT_SID";
const QString SmsSender::AUTH_TOKEN  = "YOUR_TWILIO_AUTH_TOKEN";
const QString SmsSender::FROM_NUMBER = "YOUR_TWILIO_PHONE_NUMBER";
