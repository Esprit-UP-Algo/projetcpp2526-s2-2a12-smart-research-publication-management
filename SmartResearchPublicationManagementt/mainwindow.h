...
public:
    MainWindow(Arduino *keypadArduino, Arduino *rfidArduino, RfidHandler *rfidHandler, const QString &rfidPort, QWidget *parent = nullptr);
    ~MainWindow();
...
private:
    ...
    QSystemTrayIcon *m_trayIcon = nullptr;   // Windows OS-level notifications for inventory alerts
    // =====================
    ...
    Arduino     *m_rfidArduino     = nullptr;
    RfidHandler *m_rfidHandler     = nullptr;
    QString      m_rfidExcludePort;
