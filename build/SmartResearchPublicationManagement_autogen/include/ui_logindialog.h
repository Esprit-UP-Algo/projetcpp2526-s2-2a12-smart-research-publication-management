...
""));
        ...
        btnLogin->setGeometry(QRect(40, 260, 351, 50));
        QFont font1;
        ...
        label_2->setGeometry(QRect(40, 40, 120, 20));
        label_2->setFont(font);
        Quitter = new QPushButton(groupBox_2);
        Quitter->setObjectName("Quitter");
        Quitter->setGeometry(QRect(221, 320, 170, 51));
        Quitter->setFont(font1);
        leUsername = new QLineEdit(groupBox_2);
        leUsername->setObjectName("leUsername");
        leUsername->setGeometry(QRect(40, 65, 351, 61));
        leUsername->setAlignment(Qt::AlignmentFlag::AlignCenter);
        btnFaceID = new QPushButton(groupBox_2);
        btnFaceID->setObjectName("btnFaceID");
        btnFaceID->setGeometry(QRect(40, 320, 170, 40));
        btnForgotPass = new QPushButton(groupBox_2);
        btnForgotPass->setObjectName("btnForgotPass");
        btnForgotPass->setGeometry(QRect(190, 220, 201, 31));
        ...
        logoLabel->setGeometry(QRect(489, 40, 141, 140));
...
"}\n"
""));
        logoLabel->setPixmap(QPixmap(QString::fromUtf8(":/img/images/logo_off.png")));
        ...
        QWidget::setTabOrder(btnLogin, Quitter);
    ...
    void retranslateUi(QDialog *LoginDialog)
    {
        ...
        btnFaceID->setText(QCoreApplication::translate("LoginDialog", "Scan FaceID", nullptr));
        btnForgotPass->setText(QCoreApplication::translate("LoginDialog", "Forgot Password?", nullptr));
