...
private slots:
    ...
    // AJOUTEZ CES NOUVEAUX SLOTS POUR L'INVENTAIRE
    void on_BtnInventoryAdd_clicked();
    void on_BtnInventoryEdit_clicked();
    void on_BtnInventoryDelete_clicked();
    void on_BtnInventoryApply_clicked();
    void on_BtnInventoryExport_clicked();
    void on_BtnPopupCancelInventory_clicked();
    void on_BtnPopupSaveInventory_clicked();
    void on_BtnPopupResetInventory_clicked();

private:
    void applyTheme(const QString& qssPath);
    void setupInventoryComboBoxes(); // Nouvelle fonction pour initialiser les combobox
    void setupDemoInventoryData();   // Nouvelle fonction pour les données de démo
