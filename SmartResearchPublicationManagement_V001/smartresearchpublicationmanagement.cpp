...
{
    ui->setupUi(this);
    connect(ui->BtnTheme, &QPushButton::clicked, this, [](){
        qDebug() << "BtnTheme CLICKED!";
    });


    // Initialisation Thème
    applyTheme(":/styles/styles/light.qss");
...
{
    m_dark = !m_dark;
    applyTheme(m_dark ? QString(":/styles/styles/dark.qss") : QString(":/styles/styles/light.qss"));
}
...
//  nadhem
void SmartResearchPublicationManagement::on_btnAjouter_3_clicked()
{
    ui->stackedWidget_5->setCurrentIndex(1);
}


void SmartResearchPublicationManagement::on_btnmodifier_2_clicked()
{
    ui->stackedWidget_5->setCurrentIndex(2);
}


void SmartResearchPublicationManagement::on_btnRetour_5_clicked()
{
    ui->stackedWidget_5->setCurrentIndex(0);
}


void SmartResearchPublicationManagement::on_btnRetour_6_clicked()
{
    ui->stackedWidget_5->setCurrentIndex(0);
}
